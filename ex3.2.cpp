...
struct Arrow : Shape
{
    Arrow(Point a, Point b, int ll = 25, int ww = 10);
...
Arrow::Arrow(Point a, Point b, int arrowLength, int arrowWidth)
    : l{arrowLength}, w{arrowWidth}
{
    add(a);
    add(b);
}
...
int main()
{
    ...
    Arrow arrow{Point{200, 200}, Point{800, 100}, 350, 20};
    arrow.set_style(lst);
